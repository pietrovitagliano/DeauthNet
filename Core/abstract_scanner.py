...
class AbstractScanner(ABC):
    ...
    def start_scan(self):
        ...
        try:
            ...
            while True:
                try:
                    # If the sniffer is not running, turn monitor mode on,
                    # if it's not already and then start it
                    ...
                    # The scan is performed, during this delay, by the async sniffer
                    time.sleep(self._channel_change_delay)

                    # Perform the operations that need to be executed during the scan
    ...
    def _on_scan_update(self):
        ...
        to perform the operations that need to be executed during the scan.
